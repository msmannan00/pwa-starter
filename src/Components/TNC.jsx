...
export default function TNC() {
  return (
    <>
      <p>Last updated on December 31, 2023.</p>

      <p>OVERVIEW</p>

      <p>
        This website is operated by 13899098 Canada Inc. (DBA “3oC” and “3 of
        Cups”), a Canadian Corporation registered under the Canada Business
        Corporation Act. Throughout the site and application, the terms “we”,
        “us” and “our” refer to 3oC. 3oC offers this website and its
        application, including all information, tools and services available
        from the 3oC’s website and application to you (an individual user, event
        participant, or a seller of any product and/or services) conditional
        upon your acceptance of all terms, conditions, policies and notices
        stated here.
      </p>

      <p>
        By visiting our site and application, viewing contents and/ or
        purchasing something on our site and application, you engage in our
        ...
        limitation users who are browsers, vendors, customers, third-party
        service providers, and/ or any contributors of content.
      </p>

      <p>
        Please read these Terms of Service carefully before accessing or using
        our website and application. By accessing or using any part of the 3oC
        site and the application, you agree to be bound by these Terms of
        Service. If you do not agree to all the terms and conditions of this
        agreement, then you may not access the website, the application or use
        any services. If these Terms of Service are considered an offer,
        acceptance is expressly limited to these Terms of Service.
      </p>

      <p>
        Any new features or tools which are added to the website and application
      ...
      <p>SECTION 1 - TERMS OF USING OUR SERVICE</p>

      <p>
        By agreeing to these Terms of Service, you represent that you are at
        least the age of majority in your state or province of residence and you
        have given us your consent to allow any of your minor dependents to use
        this site and application. You may not use our products and services for
      ...
      <p>
        ...
        and involve (a) transmissions over various networks; and (b) changes to
        ...
        the Service or any contact on the website and application through which
        the service is provided, without express written permission by us. You
        agree to maintain confidentiality and security of your account access
        and password. You must notify us immediately of any unauthorized use of
        your account. The headings used in this agreement are included for
      ...
      <p>
        We are not responsible if information made available on this site and
        application is not accurate, complete or current. The material on this
        site and application is provided for general information only and should
        ...
        your own risk. This site may contain certain historical information.
      ...
      <p>SECTION 5 - SERVICES AND YOUR RELATIONSHIP WITH 3OC</p>

      <p>
        3oC does not host or organize any events, meetings, and/or gatherings of
        any kind. Any of the products or services offered by any organization,
        made available through our platform are not endorsed or warranted by us
        in any way. We do not warrant that the quality of any events, services,
        information, or other material purchased or obtained by you, provided by
        us or third-party providers of any services operating on our platform
        will meet your expectations, or that any errors in the Service will be
        corrected. The third-party service provider is solely responsible for
        ensuring that any displaying of information on the services they offer
        meet all applicable local, provincial, national and other laws, rules
        and regulations, and that the goods and services described on the
        website and application are delivered as described and in an accurate
        satisfactory manner. The decision to purchase any of the services and/or
        participating in the engagement of any kind are between you and the
        third-party service provider (as they are independent and separate
        entities not affiliated with 3oC). You understand that by accessing or
        using the Services, you are not entering into a seller-customer
        relationship with 3oC. You acknowledge and agree that you will not hold
        us or any of our affiliates liable for any loss, injury, or claim of any
        kind resulting from your use and/or purchase of services, participation
        in any engagements offered by the third-party service providers on our
        platform. By accepting the Terms of Use, you agree and consent to 3oC
        sending you disclosures, notices, messages, reports, and other
        communications. It is your responsibility to monitor these
        communications. You agree that any notices, agreements, disclosures, or
        ...
        such communications be in writing. You should maintain copies of
      ...
      <p>
        ...
        return or exchange only according to our Refund Policy. We reserve the
      ...
      <p>
        All descriptions of events or product pricing are subject to change at
        any time without notice, at the sole discretion of us or the third-party
        service provider. We reserve the right to discontinue any service at any
        time. Any offer for any product or service made on this site is void
        where prohibited.
      </p>

      <p>
        SECTION 6 - SAFETY; YOUR INTERACTION WITH OTHER USERS AND THIRD-PARTY
        SERVICE PROVIDERS.
      </p>

      <p>
        Though 3oC strives to encourage a respectful user experience, 3oC is not
        responsible for the conduct of any user and/or third-party service
        provider on or off of the Service. You agree to use caution in all
        interactions with other users and third-party service providers,
        particularly if you decide to communicate and/or meet in person. In
        addition, you agree to review and follow 3oC’s Safety Tips prior to
        ...
        or wire or otherwise send money to other members.
      </p>

      <p>
        YOU ARE SOLELY RESPONSIBLE FOR YOUR INTERACTIONS WITH OTHER USERS ON THE
        3OC PLATFORM. YOU UNDERSTAND THAT 3OC DOES NOT CONDUCT CRIMINAL
        BACKGROUND CHECKS ON ITS USERS OR OTHERWISE INQUIRE INTO THE BACKGROUND
        OF ITS USERS. 3OC MAKES NO REPRESENTATIONS OR WARRANTIES AS TO THE
        CONDUCT OR COMPATIBILITY OF USERS.
      </p>

      <p>SECTION 7 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</p>

      <p>
        We reserve the right to refuse any order you place with us. We may, in
        our sole discretion, limit or cancel quantities of services purchased
        per person, per household or per order. These restrictions may include
        orders placed by or under the same user account, the same credit card,
        ...
        made on our platform. You agree to promptly update your account and
      ...
      <p>SECTION 8 - THIRD-PARTY TOOLS</p>
      ...
      <p>
        ...
        include materials from third-parties. Third-party links on this site and
        the 3oC application may direct you to third-party websites that are not
      ...
      <p>
        ...
        objectionable or violate any party’s intellectual property or these
        Terms of Service.
      </p>
      ...
      <p>
        We do not guarantee, represent or warrant any aspect of the services
      ...
      <p>
        You expressly acknowledge and agree to follow all safety instructions
        provided along with the products and/or safety instructions made
        available to you through our website.
      </p>

      <p>
        In no case shall 3oC, our directors, officers, employees, affiliates,
      ...
      <p>
        You agree to indemnify, defend and hold harmless 3oC and our
      ...
      <p>
        These Terms of Service and any policies or operating rules, including
        End User Licensing Agreement, Service Level Agreement, and any
        agreements posted by us on this site or in respect to the Service
      ...
      <p>
        ...
        <a href="mailto:society@3oc.world">society@3oc.world</a>
      </p>
    </>
  );
}
